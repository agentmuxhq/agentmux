...
If the backend server (agentmuxsrv) detects a lock conflict, it prints formatted instructions to the log explaining how to use multi-instance mode.
...
- Lock is held for the lifetime of the agentmuxsrv process
