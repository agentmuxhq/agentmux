...
const UpgradeOnboardingModal = () => {
    ...
    const handleStarClick = async () => {
        ...
        window.open("https://github.com/a5af/agentmux?ref=upgrade", "_blank");
        ...
        pageComp = (
            <div className="flex flex-col h-full">
                <header className="flex flex-col gap-2 border-b-0 p-0 mt-1 mb-6 w-full unselectable flex-shrink-0">
                    ...
                    <div className="text-center text-[25px] font-normal text-foreground">Welcome to AgentMux v0.25!</div>
                </header>
                    ...
                    <div className="flex flex-col items-center gap-3 w-full mb-2 unselectable">
                        <div className="flex flex-col items-center gap-4 max-w-md text-center">
                            <div className="flex h-[52px] px-3 items-center rounded-lg bg-hover text-accent text-[24px]">
                                ...
                                <span className="font-bold ml-2 font-mono">AgentMux AI</span>
                            </div>
                            <div className="text-secondary leading-relaxed max-w-[420px]">
                                <p className="mb-4">
                                    AgentMux AI is your new terminal assistant with full context. It can read your terminal
                                ...
                                <p className="p-3 border border-border rounded-md bg-hover/30">
                                    AgentMux AI is in active beta with included AI credits while we refine the experience.
                        ...
                        <div className="flex flex-col items-center gap-3 text-center max-w-[440px]">
                            <div className="text-foreground text-base">Thanks for being an early AgentMux adopter! ⭐</div>
                            <div className="text-secondary text-sm">
                                A GitHub star shows your support for AgentMux (and open-source) and helps us reach more
                                developers.
                            </div>
                        </div>
                    </div>
