...
Complete list of AWS resources that will be created when deploying the AgentMux Webhook Infrastructure.
...
|--------------|------------|---------------|---------|
| `AWS::DynamoDB::Table` | `WebhookConfigTable0E03631F` | `AgentMuxWebhookConfig-prod` | Stores webhook subscriptions and routing configuration |
| `AWS::DynamoDB::Table` | `ConnectionTable0C6E1E44` | `AgentMuxConnections-prod` | Tracks active WebSocket connections |
...
|--------------|------------|---------------|---------|
| `AWS::Lambda::Function` | `WebhookRouterFunctionB37723DF` | `agentmux-webhook-router-prod` | Python 3.12 |
...
#### WebSocket API (for AgentMux clients)
...
|--------------|------------|---------------|
| `AWS::SecretsManager::Secret` | `WebhookSecretF21E29CC` | `agentmux/webhook-secret-prod` |
...
**Physical Names:**
- DynamoDB Tables: `AgentMux{TableName}-{env}`
- Lambda Functions: `agentmux-webhook-router-{env}`
- Secrets: `agentmux/webhook-secret-{env}`
...
|------------|-------------|-------|
| `WebhookConfigTableName` | `agentmux-webhook-prod-WebhookConfigTable` | Table name |
| `ConnectionTableName` | `agentmux-webhook-prod-ConnectionTable` | Table name |
| `WebhookRouterFunctionArn` | `agentmux-webhook-prod-WebhookRouterArn` | Lambda ARN |
| `HttpApiEndpoint` | `agentmux-webhook-prod-HttpApiEndpoint` | HTTP API URL |
| `WebSocketApiEndpoint` | `agentmux-webhook-prod-WebSocketApiEndpoint` | WebSocket URL |
| `WebhookSecretArn` | `agentmux-webhook-prod-WebhookSecretArn` | Secret ARN |
