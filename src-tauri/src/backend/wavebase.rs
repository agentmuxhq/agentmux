...
pub const WAVE_CONFIG_HOME_ENV: &str = "WAVETERM_CONFIG_HOME";
pub const WAVE_DATA_HOME_ENV: &str = "WAVETERM_DATA_HOME";
pub const WAVE_APP_PATH_ENV: &str = "WAVETERM_APP_PATH";
pub const WAVE_DEV_ENV: &str = "WAVETERM_DEV";
pub const WAVE_DEV_VITE_ENV: &str = "WAVETERM_DEV_VITE";
pub const WAVE_WSH_FORCE_UPDATE_ENV: &str = "WAVETERM_WSHFORCEUPDATE";
pub const WAVE_JWT_TOKEN_ENV: &str = "WAVETERM_JWT";
pub const WAVE_SWAP_TOKEN_ENV: &str = "WAVETERM_SWAPTOKEN";
...
pub const REMOTE_WAVE_HOME_DIR_NAME: &str = ".waveterm";
pub const REMOTE_WSH_BIN_DIR_NAME: &str = "bin";
pub const REMOTE_FULL_WSH_BIN_PATH: &str = "~/.waveterm/bin/wsh";
pub const REMOTE_FULL_DOMAIN_SOCKET_PATH: &str = "~/.waveterm/wave-remote.sock";
...
/// Uses `WAVETERM_DATA_HOME` env var, or defaults to `~/.waveterm`.
pub fn get_wave_data_dir() -> PathBuf {
    ...
    get_home_dir().join(".waveterm")
}

/// Get the Wave config directory.
/// Uses `WAVETERM_CONFIG_HOME` env var, or defaults to `~/.waveterm/config`.
...
/// Get the Wave DB directory (`~/.waveterm/db`).
...
mod tests {
    ...
    fn test_env_var_constants() {
        assert_eq!(WAVE_CONFIG_HOME_ENV, "WAVETERM_CONFIG_HOME");
        assert_eq!(WAVE_DATA_HOME_ENV, "WAVETERM_DATA_HOME");
        assert_eq!(WAVE_DEV_ENV, "WAVETERM_DEV");
    }
    ...
    fn test_wave_data_dir_default() {
        // When env var is not set, should be ~/.waveterm
        let dir = get_wave_data_dir();
        assert!(dir.to_string_lossy().contains(".waveterm") || dir.to_string_lossy().contains("WAVETERM"));
    }
    ...
    fn test_wave_config_dir() {
        ...
        assert!(config_dir.to_string_lossy().contains("config") || config_dir.to_string_lossy().contains("WAVETERM"));
    }
