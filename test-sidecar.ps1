...
$proc = Start-Process -FilePath "src-tauri/binaries/agentmuxsrv-x86_64-pc-windows-msvc.exe" -ArgumentList "--wavedata", $env:WAVETERM_DATA_HOME -PassThru -NoNewWindow
